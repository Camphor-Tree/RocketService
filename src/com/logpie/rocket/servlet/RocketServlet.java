...
public class RocketServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			JSONObject json = RocketHttpRequestParser
					.httpRequestParser(request);
			// Get the instance of Logic
			RocketServiceCentralLogic logic = RocketServiceCentralLogic
					.getInstance();
			...
			RocketLog
					.i(TAG,
							"Servlet cannot find the correct type from HttpRequestJSONObject");
